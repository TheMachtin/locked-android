...
| Windows | `Locked-Setup-2.4.N.exe` aus demselben Release | ausführen; portable Variante liegt daneben |
| Linux | `Locked-2.4.N.AppImage` | ausführbar machen und starten |
...
berechnen (Commit-Anzahl → `2.4.N`) und sie über `scripts/bake-version.sh`
