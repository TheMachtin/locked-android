...
export function normalizeSettings(raw) {
  ...
  // `src.freeze` wird bewusst nicht übernommen: die Punktesperre gibt es nicht
  // mehr (siehe README). Dateien aus älteren Fassungen tragen das Feld noch —
  // es fällt beim nächsten Schreiben von allein heraus, statt als toter Rest
  // mitzuwandern.
  return out;
}
